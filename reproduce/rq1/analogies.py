...
if __name__ == '__main__':
  ...
  print('# RQ1 - Experiments')
  print()
 
  print('## 5.1 - Code Analogies')
  # Run the tests!
  run_all(TESTS, K, M)
  print()

  print('## 5.2 - Simple Similarity')
  # Run similarity tests!
  similarity.closest_words(M)
  similarity.print_top_words(M)
  print()

  print('## 5.3 - Queries via Word-Vector Averaging')
  # Run averaging tests!
  averaging.queries_via_averaging(M)
  print()
